...
CliantController = (function(_super) {
  ...
  function CliantController(socket) {
    ...
    this.socket.onmessage = function(a) {
      return _this.receive(_this.json_to_action(a.data));
    };
    this.socket.onopen = function() {
      console.log("connect");
      return _this.socket.send(_this.action_to_json({
        type: "join",
        name: "",
        room: "default"
      }));
  ...
  CliantController.prototype.send = function(a) {
    console.log("send", this.action_to_json(a));
    return this.socket.send(this.action_to_json(a));
  };
